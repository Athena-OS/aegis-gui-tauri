            ...
            case "ArrowUp":
                ...
                while (prevOptionElement) {
                    if (
                        ...
                        break;
                    prevOptionElement =
                        prevOptionElement.previousElementSibling;
                }
...
<div class="combobox flex w-full flex-col items-center justify-center">
    <div class="w-full">
            ...
            <div class="input-container" use:onClickOutside={hideList}>
                ...
                >
                    ...
                    <input
                        ...
                        {id}
                        {name}
                        class="w-[80%] h-[50px] flex relative items-center space-x-4 text-left rounded-full overflow-hidden border-neutral-800 px-3.5 text-lg hover:border-primary-500 outline-none bg-neutral-900"
                        type="text"
                        {disabled}
                        autocapitalize="none"
                        autocomplete="off"
